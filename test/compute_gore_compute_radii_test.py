...
from compute_gore import compute_radii

class ComputeRadiiTestCase(unittest.TestCase):
    
    def test_with_default_step_size(self):
        actual_radii = compute_radii()
        expected_length = 91
    ...
    def test_with_step_size_0_5(self):
        actual_radii = compute_radii(step_size=0.5)
        expected_length = 181
        expected_start_value = 90.0
        expected_stop_value = 0.0
    ...
    def test_with_step_size_2_5(self):
        actual_radii = compute_radii(step_size=2.5)
        expected_length = 37
        expected_start_value = 90.0
        expected_stop_value = 0.0
